    ...
    .controller('mainCrtl', ['$scope', function ($scope) {
        ...
        if ("geolocation" in navigator) {
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                var API = "https://crossorigin.me/http://api.openweathermap.org/data/2.5/forecast?lat=" + latitude + "&lon=" + longitude + "&appid=626020384932586fe3fdaafc11b18c48&units=imperial";
